...
## Pyside
For our graphical interface we used the framework Pyside6. Although lectures had explained Tkinter, by that point we had already decided on Pyside as our framework based on our own research.
